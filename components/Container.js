...
export default function Container(props) {
  ...
  const meta = {
    ...
    image: "https://karthikmudunuri.io/static/images/banner.png",
    type: "website",
    ...customMeta,
  };
  ...
  return (
    <div className="bg-white dark:bg-zinc-900">
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://karthikmudunuri.io${router.asPath}`}
        />
        <link rel="canonical" href={`https://karthikmudunuri.io${router.asPath}`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Karthik Mudunuri" />
